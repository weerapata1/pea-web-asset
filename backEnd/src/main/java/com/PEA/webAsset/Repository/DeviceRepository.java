...
public interface DeviceRepository extends JpaRepository<tbDevice, Long>, CustomDeviceRepository {
        ...
        @Query(value = "SELECT d.device_id, d.dev_description, d.dev_pea_no, d.dev_serial_no, " +
                        ...
                        "LEFT JOIN tb_employee e ON d.emp_id = e.emp_id " +
                        "LEFT JOIN tb_cost_center c ON d.cc_long_code = c.cc_long_code " +
                        "WHERE d.is_deleted = 0 AND (d.cc_long_code LIKE CONCAT(:ccLong,'%')) ", nativeQuery = true)
        ...
        @Query(value = "SELECT d.device_id, d.dev_description, d.dev_pea_no, d.dev_serial_no, " +
                        ...
                        "LEFT JOIN tb_employee e ON d.emp_id = e.emp_id " +
                        "LEFT JOIN tb_cost_center c ON d.cc_long_code = c.cc_long_code " +
                        "WHERE d.is_deleted = 0 AND (d.cc_long_code LIKE CONCAT(:ccLong,'%') OR d.cc_long_code LIKE 'ZC%')", nativeQuery = true)
        ...
        @Query(value = "WITH base AS ( " +
                        ...
                        "   LEFT JOIN tb_cost_center c ON d.cc_long_code = c.cc_long_code " +
                        "   LEFT JOIN tb_employee e    ON d.emp_id = e.emp_id " +
                        "   WHERE d.device_type_id = 1 AND d.is_deleted = 0 " +
                        ") " +
                        "SELECT b.device_id, " +
                        "       b.dev_pea_no, " +
                        "       b.dev_description, " +

...
//
    ...
    private LocalDateTime createdDate; //วันที่รับดำเนินการ

    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "Asia/Bangkok")
    private LocalDateTime lastModifyDate; //วันที่ดำเนินการล่าสุด

    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "Asia/Bangkok")
    private LocalDateTime closedDate; //วันที่สิ้นสุดการซ่อม
...
//    private String assignedTo; // เจ้าหน้าที่รับเครื่อง
    ...
    @ManyToOne(fetch = FetchType.EAGER) //ผู้รับผิดชอบงานซ่อม
    @JoinColumn(name = "assignedTo")
    private tbEmployee assignedTo;

    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "consigneeName")
    private tbEmployee consigneeName; // หน้างานมารับเครื่องคืน

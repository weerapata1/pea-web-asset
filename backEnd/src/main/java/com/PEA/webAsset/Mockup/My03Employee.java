...
//
// @Component
// public class My03Employee implements ApplicationRunner {
//     @Autowired
//     public void run(ApplicationArguments args){}
//
//     @Bean
//     public ApplicationRunner MyEmployee(EmployeeRepository employeeRepository, CostCenterRepository costCenterRepository, EmpRuleRepository empRuleRepository){
//         return (args ->{
////             employeeRepository.save((new tbEmployee("512099","วีรภัทร ทวีศักดิ์","นรค.4","ผปค. กรท. ฝบพ.(ฉ2)","costCenterRepository.findByCcLongCode("E301023040")","empRuleRepository.fin")));
//
//
